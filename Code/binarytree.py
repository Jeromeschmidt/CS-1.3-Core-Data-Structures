...
from queue2 import LinkedQueue
...
class BinarySearchTree(object):
    ...
    def contains(self, item):
        ...
        TODO: Worst case running time: O(logn) under worst conditions"""
    ...
    def insert(self, item):
        ...
        TODO: Best case running time: O(1), if node is root?
        TODO: Worst case running time: O(logn) under worst conditions since you have to find where to put node"""
    ...
    def _find_node_iterative(self, item):
        ...
        TODO: Best case running time: O(1), if node is root
        TODO: Worst case running time: O(logn)"""
    ...
    def _find_node_recursive(self, item, node):
        ...
        TODO: Best case running time: O(1), if node is root
        TODO: Worst case running time: O(logn) if node is in lowerest branch"""
    ...
    def _find_parent_node_iterative(self, item):
        ...
        TODO: Worst case running time: O(logn) if node is in lowest branch"""
    ...
    def _traverse_in_order_recursive(self, node, visit):
        ...
        TODO: Running time: O(n), must visit every node
    ...
    def _traverse_level_order_iterative(self, start_node, visit):
        ...
        Start at the given node and visit each node with the given function.
        TODO: Running time: O(n), have to visit every node
        TODO: Memory usage: O(n) nodes are stored in queue"""
